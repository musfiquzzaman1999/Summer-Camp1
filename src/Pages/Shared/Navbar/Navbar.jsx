            ...
            {user ? (
              <div className="flex gap-4 items-center">
                ...
                <Link
                  ...
                  className="hidden md:block MBtn"
                >
                  Log Out
                </Link>
              </div>
            ) : (
              <Link to="/login" className="hidden md:block MBtn">
                Login
              </Link>
            )}
                ...
                <div className="flex gap-4 items-center">
                  ...
                  >
                    {user.photoURL ? (
                      <div className="flex">
                        <img
                        className="w-10 h-10 object-fill mx-auto rounded-full border-2 border-red-400 "
                        src={user.photoURL}
                        alt=""
                      />
                      </div>
